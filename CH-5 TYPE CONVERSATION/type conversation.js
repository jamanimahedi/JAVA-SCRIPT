...
console.log(String(12) + 24);

//Example 9 
console.log("Example 9");
console.log(Number("70") / 30);
...
console.log(Number(90) * 40);

//Example 14
console.log("Example 14");
console.log(String(14) + 9);
...
console.log(String("MahediRaza") + 6)
...
console.log(Number(null) + Number("MahediRaza"))
...
console.log(String(45) + Number(3))
...
console.log(10 - "45" + 87)


//Example 38

console.log("Example 38")
console.log(String(89) + String(11))


//Example 39

console.log("Example 39")
console.log(34 - "23" + "43")


//Example 40

console.log("Example 40")
console.log(20 + "30" + 34)


//Example 41

console.log("Example 41")
console.log(12 - "34" + "90")
